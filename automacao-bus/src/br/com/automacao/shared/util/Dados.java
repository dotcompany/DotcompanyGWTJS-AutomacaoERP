...
//	protected Colecao[] colecao;
	...
	protected DirecaoType ordemDirecao;
	protected LetraType tipoLetra;
	...
	public Dados(String pu, String tabela, String campoId, String campoOrdem) {
		this(pu, tabela, campoId, campoOrdem, DirecaoType.ASC);
	}
	 ...
	 */
	public Dados(String pu, String tabela, String campoId, String campoOrdem, DirecaoType ordemDirecao) {
		this.pu = pu;
		this.tabela = tabela;
		this.campoId = campoId;
		this.campoOrdem = UtilClient.getCampoPrefixado(campoOrdem);
		this.ordemDirecao = ordemDirecao;
		this.tipoLetra = LetraType.GRANDE;
	 ...
	 */
	public DirecaoType getOrdemDirecao() {
		return ordemDirecao;
	}
...
//	}
	 ...
	 */
	public void setOrdemDirecao(DirecaoType ordemDirecao) {
		this.ordemDirecao = ordemDirecao;
	}
...
//	}
	 ...
	 *            o tipo.
	 */
	public void setTipoLetra(LetraType tipoLetra) {
