...
import br.com.automacao.client.widget.formularios.FabricaFormulario;
...
public class GridBase<M extends DotModel, T extends Mirror> extends DotWindow {
...
//	private Button saveGridButton = new Button(null, DesktopApp.IMG.img_save());
	...
	public GridBase(DotProxy dotProxy, FileColumn fc, String header) {
		super(header);
		this.dotProxy = dotProxy;
		this.rpcProxy = dotProxy.getRpcProxy();
		this.fileColumn = fc;
		this.nameClasse = fc.getNameClasse();
		this.formulario = FabricaFormulario.getFormulario(this, nameClasse);
